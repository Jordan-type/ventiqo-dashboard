...
import { fetchAllOrders } from "@/config/ordersAPI";
  ...
  return (
            ...
            {orders.map((order) => (
              <TableRow key={order._id}>
                <TableCell>
                  <div className="font-medium">{`${order.personalDetail.first_name} ${order.personalDetail.last_name}`}</div>
                  <div className="hidden text-sm text-muted-foreground md:inline">
                    {order.personalDetail.email}
                  </div>
                </TableCell>
